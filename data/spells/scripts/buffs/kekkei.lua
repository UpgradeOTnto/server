...
local ml = 18 -- quantos ira aumentar o skill de ML
local skillfist = 0 -- quantos ira aumentar o skill de Fist
local skillsword = 18 -- quantos ira aumentar o skill de Sword
local skillaxe = 0 -- quantos ira aumentar o skill de Axe
local skillclub = 18 -- quantos ira aumentar o skill de Club
local skilldistance = 18 -- quantos ira aumentar o skill de Distance
...
if getPlayerStorageValue(cid, 102053) ~= 1 or getCreatureCondition(cid, CONDITION_REGENERATION, 1) == false then
	...
	repeatEff(cid, 12, 120)
    doCreatureSay(cid, "Kekkei Genkai", TALKTYPE_MONSTER)
else
