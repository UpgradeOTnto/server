...
addEvent(doSendDistanceShoot, 200, getCreaturePosition(cid), pos, 25)
addEvent(doSendDistanceShoot, 400, getCreaturePosition(cid), pos, 25)
addEvent(doSendDistanceShoot, 600, getCreaturePosition(cid), pos, 25)
addEvent(doSendDistanceShoot, 800, getCreaturePosition(cid), pos, 25)
addEvent(doSendDistanceShoot, 1000, getCreaturePosition(cid), pos, 25)
