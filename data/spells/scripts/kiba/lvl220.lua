...
setCombatFormula(combat3, COMBAT_FORMULA_LEVELMAGIC, -2.2, 1, -2.2, 1)
...
addEvent(doSendMagicEffect, 200, {x = pos.x+0, y = pos.y+0, z = pos.z}, 0)
addEvent(doSendMagicEffect, 600, {x = pos.x+0, y = pos.y+0, z = pos.z}, 0)
addEvent(doSendMagicEffect, 1000, {x = pos.x+0, y = pos.y+0, z = pos.z}, 0)
