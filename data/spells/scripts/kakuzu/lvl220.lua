...
addEvent(doSendMagicEffect, 200, {x = pos.x+1, y = pos.y, z = pos.z}, 119)
addEvent(doSendMagicEffect, 600, {x = pos.x+1, y = pos.y, z = pos.z}, 119)
addEvent(doSendMagicEffect, 1000, {x = pos.x+1, y = pos.y, z = pos.z}, 119)
